...
import { binarySearch, recursiveBinarySearch } from './binarySearch.js';
...
describe('Recursive BinarySearch', () => {
    ...
    test('Search value in left half', () => {
        const find = recursiveBinarySearch(1, array);
        expect(find).toBe(3);
    });

    test('Search value in right half', () => {
        const find = recursiveBinarySearch(4, array);
        expect(find).toBe(8);
    });

    test('Search for first value', () => {
        const find = recursiveBinarySearch(-432, array);
        expect(find).toBe(0);
    });

    test('Search for last value', () => {
        const find = recursiveBinarySearch(98, array);
        expect(find).toBe(11);
    });

    test('Search for a value that is not in the array', () => {
        const find = recursiveBinarySearch(8, array);
        expect(find).toBe(-1);
    });
});
